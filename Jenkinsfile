        ...
        stage('Cloning Github repo to Jenkins'){
            steps{
                script{
                    ...
                    checkout scmGit(branches: [[name: '*/main']], extensions: [], userRemoteConfigs: [[credentialsId: 'github-token', url: 'https://github.com/danireagan/AI-Medical-Agent-Project.git']])
                }
            }
        }
        ...
        withCredentials([[$class: 'AmazonWebServicesCredentialsBinding', credentialsId: 'aws-token']]) {
            script {
                ...
                aws ecs update-service \
                  ...
                  --service ai-agent-def-service-20fzho8r  \
